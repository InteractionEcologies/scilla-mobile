...
export default {
  ...
  activeTab: platform === PLATFORM.IOS ? Colors.primaryColor : '#fff',
  sTabBarActiveTextColor: Colors.primaryColor,
  tabBarActiveTextColor: platform === PLATFORM.IOS ? Colors.primaryColor : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#3F51B5',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? Colors.primaryColor : '#fff',
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? Colors.primaryColor : '#fff',
